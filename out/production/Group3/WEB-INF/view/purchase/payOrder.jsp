        ...
        <form>
            ...
            <div class="row">
                ...
                <table id="paymentTable">
                    <tr>
                        <td><label><input type="checkbox" class="paymentMethod" name="paymentMethod" value="card"
                                          checked="checked"><span>신용카드</span></label></td>
                        <td><label><input type="checkbox" class="paymentMethod" name="paymentMethod"
                                          value="account"><span>계좌이체</span></label></td>
                        <td><label><input type="checkbox" class="paymentMethod" name="paymentMethod" value=""><span>무통장 입금</span></label>
                        </td>
                    </tr>
                    <tr>
                        <td><label><input type="checkbox" class="paymentMethod" name="paymentMethod" value="toss"><span>toss</span></label>
                        </td>
                        <td><label><input type="checkbox" class="paymentMethod" name="paymentMethod"
                                          value="kakaoPay"><span>kakao pay</span></label></td>
                        <td><label><input type="checkbox" class="paymentMethod" name="paymentMethod"
                                          value="payco"><span>payco</span></label></td>
                    </tr>
                    <tr>
                        <td><label><input type="checkbox" class="paymentMethod" name="paymentMethod"
                                          value="mobile"><span>핸드폰 결제</span></label></td>
                    </tr>
                </table>
            </div>

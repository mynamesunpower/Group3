...
<br/>
<div class="row">
    <div class="col s8 offset-s3 center-align">
                            ...
                            <c:otherwise>
                                <c:forEach var="cart" items="${cart}">
                                    <tr>
                                        <td>${cart.bookVO.title}</td>
                                            <%--가격에 천단위 가격으로 formatting--%>
                                        <td><fmt:formatNumber value="${cart.bookVO.price * cart.quantity}"
                                                              pattern="#,###"/>원
                                        </td>
                                        <td>${cart.quantity}</td>
                                    </tr>
        ...
        <form id="orderForm" method="post">
            <div class="row">
                ...
                <div id="totalPrice" class="col s3">총 금액 : <fmt:formatNumber value="${totalPrice}" pattern="#,###"/>원
                </div>

                <%-- TODO 회원등급에 따라 적립 비율 다르게 해주기--%>
                <input type="hidden" id="point" name="point" value="${totalPrice * 0.05}">
                <div class="col s8">적립예정 포인트 : <fmt:formatNumber value="${totalPrice * 0.05}" pattern="#,###"/> Point
                </div>
            </div>
            <div class="row">
                <div class="col s4 offset-s6">
                    <a href="/cart/cartList.ing" id="returnCart"
                       class="loadAjax waves-effect waves-light btn-small white black-text">
            ...
            <div class="row">
                <table id="deliveredTable" class="hilight centerd">
                    ...
                    <tr>
                        ...
                        <td><input type="text" id="addr1" name="addr1" value="${sessionScope.memberAddr1}"
                                   placeholder="우편번호"></td>
                        <td>
                    ...
                    <tr>
                        <td><input type="text" id="addr2" name="addr2" value="${sessionScope.memberAddr2}"
                                   placeholder="주소"></td>
                    </tr>
                    <tr>
                        <td><input type="text" id="addr3" name="addr3" value="${sessionScope.memberAddr3}"
                                   placeholder="상세주소"></td>
                    </tr>
                    <tr>

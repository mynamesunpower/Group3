        ...
        <div class="col s8">
            ...
            <div id="test1" class="col tab-content">
                <ul class="collapsible" data-collapsible="accordion">
                    <li>
                        <div class="collapsible-header"><h4> [배송] 주문한 상품은 언제 받을 수 있을까요?</h4></div>
                    ...
                    <li>
                        <div class="collapsible-header"><h4>[배송] 몇시까지 주문하면 배송이 되나요?</h4></div>
                    ...
                    <li>
                        <div class="collapsible-header"><h4>[배송지연 보상제] 배송지연 보상제는 무엇인가요?</h4></div>
                        <div class="collapsible-body"><p>
                    ...
                    <li>
                        <div class="collapsible-header"><h4>[배송] 부분 출고란 무엇인가요?</h4></div>
                        <div class="collapsible-body"><p>
                    ...
                    <li>
                        <div class="collapsible-header"><h4>[배송] 배송 방법에는 어떤 것이 있나요?</h4></div>
                        <div class="collapsible-body"><p>
            ...
            <div id="test2" class="col tab-content">
                <ul class="collapsible" data-collapsible="accordion">
                    <li>
                        <div class="collapsible-header"><h4>[교환] 다른상품으로 교환 가능하나요?</h4></div>
                        <div class="collapsible-body"><p>다른상품으로는 교환이 불가합니다.<br/>
                            상품을 잘못 구매하셨을 경우 반품 후 새로 재 주문 해주세요.</p></div>
                    </li>
                    <li>
                        <div class="collapsible-header"><h4>[환불] 반품완료 후 어떻게 환불 받을 수 있나요?</h4></div>
                        <div class="collapsible-body"><p>
                    ...
                    <li>
                        <div class="collapsible-header"><h4>[반품] 마음에 들지 않아 반품하는 경우는 어떻게 하나요?</h4></div>
                    ...
                    <li>
                        <div class="collapsible-header"><h4>[반품] 반품이 가능한 경우와 불가능한 경우에는 어떤 것이 있나요?</h4></div>
                        <div class="collapsible-body">
                            <p>반품이 가능한 경우<br/>
            ...
            <div id="test3" class="col tab-content">
                <ul class="collapsible" data-collapsible="accordion">
                    <li>
                    <div class="collapsible-header"><h4>[무통장입금] 무통장입금로 결제할 경우, 언제 입금 확인이 되나요?</h4></div>
                    <div class="collapsible-body"><p>
                        ...
                        <li>
                        <div class="collapsible-header"><h4>[취소] 신용카드 결제 후, 부분 취소는 어떻게 하나요?</h4></div>
                        <div class="collapsible-body"><p>
                        ...
                        <li>
                        <div class="collapsible-header"><h4>[휴대폰 결제] 휴대폰 결제를 사용할 수 없는 경우도 있나요?</h4></div>
                        <div class="collapsible-body"><p>
                        ...
                        <li>
                        <div class="collapsible-header"><h4>[결제일반] 소비자 피해보상 보험(서울보증 보험)은 언제 신청하며, 어떻게 확인할 수 있나요?</h4></div>
                        <div class="collapsible-body"><p>
                        ...
                        <li>
                        <div class="collapsible-header"><h4>[무통장입금] 무통장입금(은행송금)은 어떻게 하나요?</h4></div>
                        <div class="collapsible-body"><p>
            ...
            <div id="test4" class="col tab-content">
                <ul class="collapsible" data-collapsible="accordion">
                    <li>
                        <div class="collapsible-header"><h4>[회원정보] 개인정보 유효기간제 가 무엇인가요?</h4></div>
                        <div class="collapsible-body"><p>
                    ...
                    <li>
                        <div class="collapsible-header"><h4>[로그인] 비밀번호 변경은 어떻게 하나요 ?</h4></div>
                        <div class="collapsible-body"><p>
                    ...
                    <li>
                        <div class="collapsible-header"><h4>[회원정보] 회원 회원탈퇴 후 개인정보는 언제 삭제되나요?</h4></div>
                        <div class="collapsible-body"><p>

...
&lt;%&ndash;<<<<<<< HEAD&ndash;%&gt;
        &lt;%&ndash;<div id="test1" class="col s4">&ndash;%&gt;
            &lt;%&ndash;<form action="memberlogin.ing" name="memberlogin" id="memberlogin">&ndash;%&gt;
                &lt;%&ndash;<input type="text" id="id" name="id" placeholder="ID 입력">&ndash;%&gt;
                &lt;%&ndash;<input type="text" id="pass" name="pass" placeholder="비밀번호 입력"><br/>&ndash;%&gt;
                &lt;%&ndash;<input type="submit" id="memlogin" name="memlogin" value="로그인">&ndash;%&gt;
            &lt;%&ndash;</form>&ndash;%&gt;
            &lt;%&ndash;&lt;%&ndash; 회원 로그인확인 form &ndash;%&gt;&ndash;%&gt;

            &lt;%&ndash;<input type="button" id="memsearchid" name="memsearchid" value="아이디찾기">&ndash;%&gt;
            &lt;%&ndash;&nbsp; / &nbsp;&ndash;%&gt;
            &lt;%&ndash;<input type="button" id="memsearchpass" name="memsearchpass" value="비밀번호찾기"><br/><br/>&ndash;%&gt;
&lt;%&ndash;=======&ndash;%&gt;

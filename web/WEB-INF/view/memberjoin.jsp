...
<body>
    <form action="userok.ing" name="userinput" id="userinput" method="post">
        ...
        비밀번호 : <input type="password" name="password" id="password" required><br/><br/>

        비밀번호확인 : <input type="password" name="password2" id="password2" required><br/><br/>

    이름 : <input type="text" name="name" id="name" required><br/><br/>

    전화번호 : <input type="select" name="tel" id="tel" placeholder="-는 빼고 입력해주세요" required><br/><br/>

    주민등록번호 : <input type="text" name="jumin1" id="jumin1" required>
    -
    <input type="text" name="jumin2" id="jumin2" required><br/><br/>

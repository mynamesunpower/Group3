...
<table border="2">
    ...
    <tr>
        ...
        <td><input type="text" name="Publisher_number" id="Publisher_number"></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td><input type="text" name="Total_page" id="Total_page"></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td> <input type="date" name="Publication_date" id="Publication_date"></td>
    </tr>
    <tr>
